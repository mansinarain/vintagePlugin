...
jQuery.fn.vintage = function (options) {
    ...
    return this.each(function () {
        ...
        var obj = jQuery(this),
            ctx;
         //   loader;
		var canvas = window.content.document.getElementById('myCanvas');

        /**
         * Check if the object is an image
         */
        if (!obj.is('img')) {
		//alert("in image not found");
            return;
        }
        ...
        var process = function () {
          //  alert("in process");
			...
			//canvas = window.content.document.getElementById('myCanvas');
            if (!canvas.getContext) {
               alert("browser is incompatable");
            } else {
		//	alert("in else of process");
