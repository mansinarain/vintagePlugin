 ...
 * ***** END LICENSE BLOCK ***** */
 ...
 var settings = {
  ...
  relativeToMouseChange: function ()
  {
    var relativeToCursor = document.getElementById("relative_to_cursor").checked;
    document.getElementById("offset_x").disabled = relativeToCursor;
    document.getElementById("offset_y").disabled = relativeToCursor;
    return undefined;
  }
